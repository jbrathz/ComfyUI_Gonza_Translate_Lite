...
- ใช้ node type เป็น `Translate` เพื่อเอาไปต่อใน workflow ได้ตรง ๆ
...
รีสตาร์ต ComfyUI จากนั้น node `Translate` จะพร้อมใช้งานใน workflow
...
- ถ้า prompt เป็นอังกฤษล้วน node จะส่งผ่านข้อความต้นฉบับโดยไม่แปล
